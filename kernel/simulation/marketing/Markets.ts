import { Market }  from '../../engine/ComputeEngine/Marketing';
...
let basicDemandMatrix = [
    [2000, 1000, 800], // avg maturity max by period
    [2100, 1200, 900],
