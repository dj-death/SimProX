(function () {
	...
	angular.module('marksimos.websitecomponent').directive('assetManagement', ['Label', '$http','$location','$filter', '$q', function(Label, $http,$location,$filter, $q){
        return {
            scope : {
                isPageShown : '=',
                isPageLoading : '=',
            ...
            restrict : 'E',
            templateUrl : '/app/partials/sim/decisions/SD_assetManagement.html',
