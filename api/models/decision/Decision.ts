...
import decisionSchema = require('./CompanyDecSchema');
let Decision = mongoose.model('Decision', decisionSchema);



export function  getPlayerReportOrder(seminar, period, playerID) {
...
export function  exportToBinary(options) {
    var deferred = q.defer();
...
export function  addAllDecisions (options) {
    var deferred = q.defer();
...
export function addDecisions(seminarId: string, periods: number[], endWithPlayerID: number, raw) {
    var deferred = q.defer();
...
export function  addPeriodResults(options, raw) {
    var deferred = q.defer();

    var rawRecordsNb = raw.length;

    var startFromPlayerID = options.startFromPlayerID,
        endWithPlayerID = options.endWithPlayerID;
...
export function  getReportPurchaseStatus(req, res, next) {
    Decision.findOne({
...
export function  updateDecision(io) {
...
export function  getAllDecision(req, res, next) {
...
export function  getPlayerCurrentDecision (req, res, next) {
    Decision.findOne({
        seminar: req.params.seminar,
        period: req.params.period,
        playerID: req.params.playerID
...
//companyHistory
export function  getCompanyHistory (req, res, next) {
    Decision.findOne({
        seminar: req.params.seminar,
        period: req.params.period,
        playerID: req.params.playerID
...
export function  resetRawDecision (rawDec) {
    var dec: any = {}
...
export function  removePlayersDecisions (options) {
    var deferred = q.defer();
