...
var userRoles = require('../../../public/js/routingConfig.js').userRoles;
var console = require('../../../kernel/utils/logger');
var config = require('../../../config');
var EngineConfig = config.engine;
var seminarSchema = require('./Schema');
...
exports.localStrategy = new LocalStrategy(function (username, password, done) {
    ...
    for (var i = 0; i < username.length; i++) {
        if (username[i] == '^')
            ...
            parameters[j] = parameters[j] + username[i];
        if (j > 2)
            break;
    }
    var para_seminar = parameters[0], para_role = parameters[1], para_roleID = parameters[2];
    Seminar.findOne({
...
function getSeminarReportPurchaseStatus(req, res, next) {
    // body...
...
exports.getSeminarReportPurchaseStatus = getSeminarReportPurchaseStatus;
function getSeminarInfo(req, res, next) {
    var tempSeminar = {};
    return Seminar.findOne({
        seminarCode: req.params.seminar
    }, function (err, doc) {
...
exports.getSeminarInfo = getSeminarInfo;
function checkPlayerDecisionStatus(req, res, next) {
    Seminar.findOne({
        seminarCode: req.params.seminar
    }, function (err, doc) {
        if (err) {
...
exports.checkPlayerDecisionStatus = checkPlayerDecisionStatus;
function submitFinalDecision(io) {
...
exports.submitFinalDecision = submitFinalDecision;
/*
...
function deleteSeminar(req, res, next) {
...
exports.deleteSeminar = deleteSeminar;
function addSeminars(req, res, next) {
    var values = {
        seminarCode: req.body.seminarCode,
...
exports.addSeminars = addSeminars;
function updateSeminar(io) {
    return function (req, res, next) {
        var queryCondition = {
            seminarCode: req.body.seminarCode,
 ...
 * TODO: keep it ?
 */
function getPlayerReportOrder(req, res, next) {
    Seminar.findOne({
        seminarCode: req.params.seminar
    }, function (err, doc) {
        if (err) {
...
function getTimerActiveInfo(req, res, next) {
    Seminar.findOne({
        seminarCode: req.params.seminar
    }, function (err, doc) {
        if (err) {
...
exports.getTimerActiveInfo = getTimerActiveInfo;
function initializeSeminar(options) {
...
exports.initializeSeminar = initializeSeminar;
function passiveSeminar(options) {
    var deferred = q.defer();
    Seminar.findOne({
        seminarCode: options.seminar
    }, function (err, doc) {
...
exports.passiveSeminar = passiveSeminar;
;
function getSimulationParams(options) {
    var deferred = q.defer();
    Seminar.findOne({
        seminarCode: options.seminar
    }, function (err, doc) {
...
exports.getSimulationParams = getSimulationParams;
;
function kernelSeminar(options) {
    var deferred = q.defer();
    Seminar.findOne({
        seminarCode: options.seminar
    }, function (err, doc) {
...
exports.kernelSeminar = kernelSeminar;
...
function duplicateSeminar(req, res, next) {
    var queryCondition = {
...
exports.duplicateSeminar = duplicateSeminar;
...
function setTimer(io) {
    ...
    */
    timersEvents.on('deadlineDecisionCommitted', function (seminarCode) {
        ...
        var singleTimer = _.find(timers, function (obj) {
            return obj.seminarCode == seminarCode;
        });
        if (singleTimer) {
            clearInterval(singleTimer);
    ...
    return function (req, res, next) {
        ...
        var timer = _.find(timers, function (obj) {
...
*/
function checkPlayerDecisionStatusByAdmin(seminarCode, period, producer) {
    var d = q.defer();
    var result = {
        //'isPortfolioDecisionCommitted': false,
        //'isContractDeal': false,
...
exports.checkPlayerDecisionStatusByAdmin = checkPlayerDecisionStatusByAdmin;
/*
 * TODO: keep it ?
 */
/*
