 ...
 */
export function getDecision (seminarId, period, companyId) {
    return Q.all([
 ...
 */
export function getAllCompanyDecisionsOfAllPeriod (seminarId) {
    return Q.all([
 ...
 */
export function getCompanyDecision (decision) {
 ...
 * @param {Object} decision decision got from CGI service
 */
export function getBrandDecisions (decision) {
    let results = [];
 ...
 * @param {Object} decision decision got from CGI service
 */
export function getSKUDecisions (decision) {
    let results = [];
