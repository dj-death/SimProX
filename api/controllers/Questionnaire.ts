import questionnaireModel = require('../models/Questionnaire');
...
export function getQuestionnaire(req, res, next) {
...
export function submitQuestionnaire (req, res, next) {
...
export function getQuestionnaireListForAdmin (req, res, next) {
    //去除非法的seminarId
