...
import decisionConvertor = require('../../convertors/decision');
 ...
 */
export function submitDecision (req, res, next) {
...
export function getDecision (req, res, next) {
    let seminarId = req.gameMarksimos.currentStudentSeminar.seminarId;
    let period = req.gameMarksimos.currentStudentSeminar.currentPeriod;
...
export function getDecisionForFacilitator (req, res, next) {
...
export function updateCompanyDecision (req, res, next) {
...
export function lockCompanyDecision (req, res, next) {
