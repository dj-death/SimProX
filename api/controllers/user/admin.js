...
;
function updateDistributor(req, res, next) {
    if (!req.body.id) {
...
function updateFacilitator(req, res, next) {
    ...
    if (req.body.mobilePhone)
        facilitator.mobilePhone = req.body.mobilePhone;
    if (req.body.country)
        facilitator.country = req.body.country;
    if (req.body.state)
        facilitator.state = req.body.state;
    if (req.body.city)
    ...
    if (req.body.district)
        facilitator.district = req.body.district;
    if (req.body.street)
        facilitator.street = req.body.street;
    if (req.body.idcardNumber)
        facilitator.idcardNumber = req.body.idcardNumber;
...
function updateStudent(req, res, next) {
    ...
    if (req.body.mobilePhone)
        student.mobilePhone = req.body.mobilePhone;
    if (req.body.country)
    ...
    if (req.body.password)
        student.password = userModel.generateHashPassword(req.body.password);
    if (req.body.idcardNumber)
        student.idcardNumber = req.body.idcardNumber;
    if (req.body.gender)
    ...
    if (req.body.university)
        student.organizationOrUniversity = req.body.university;
    if (req.body.majorsDegree)
        student.majorsDegree = req.body.majorsDegree;
...
exports.listStudentNumberByDay = listStudentNumberByDay;
;
