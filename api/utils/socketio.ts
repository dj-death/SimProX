...
import userRole = require('../models/user/UserRole');
...
export function emitMarksimosDecisionUpdate(roomName, data){
    global.gsocketio.to(roomName).emit('marksimosDecisionUpdate', data);
};


export function emitMarksimosChatMessageSeminar(roomName, user, message){
...
export function emitMarksimosChatMessageCompany (roomName, user, message){
