...
export function  createEmailSender(sendmethod: string = 'webapi', serversettings: any = serverSettingsDefault) {
...
NodemailerSendCloud.prototype.sendMail = function  (mail: any, callback) {
...
NodemailerSendCloud.prototype.sendMailQ = function  (mail: any) {
